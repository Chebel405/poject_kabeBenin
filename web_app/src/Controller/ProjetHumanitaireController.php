...
class ProjetHumanitaireController extends AbstractController
{
    ...
    public function index(Request $request): Response
    {
        ...
        return $this->render('ProjetHumanitaire/projetHumanitaires.html.twig', [
            'paginator' => $paginator
        ]);
    }
    ...
    public function afficherProjetHumanitaire(int $id): Response
    {
        ...
        return $this->render('ProjetHumanitaire/projetHumanitaire.html.twig', [
    ...
    public function ajoutProjetHumanitaire(Request $request): Response
    {
        if ($request->getMethod() == "GET")
            return $this->render('ProjetHumanitaire/ajout.ProjetHumanitaire.html.twig', []);
        else {
            ...
            $newProjetHumanitaire->setPrix($request->get("prix"));
            $newProjetHumanitaire->setQuantite($request->get("quantite"));
            $newProjetHumanitaire->setDisponibilite($request->get("disponibilite"));
            // $newProjetHumanitaire->setPhoto($request->get("photo"));
            // $newProjetHumanitaire->setEvenement($request->get("evenement"));
